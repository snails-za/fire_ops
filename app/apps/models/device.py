...
class Device(BaseModel):
    ...
    name = fields.CharField(
        max_length=100, null=True, index=True, description="设备名称"
    )
    ...
    installer_contact = fields.CharField(
        max_length=11, null=True, description="安装人联系方式（手机号）"
    )
    contact = fields.CharField(
        max_length=11, null=True, description="维护人联系方式（手机号）"
    )
