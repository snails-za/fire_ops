...
class User(BaseModel):
    ...
    fullname = fields.CharField(max_length=50, description="姓名")
    email = fields.CharField(
        null=True, max_length=50, unique=True, index=True, description="邮箱"
    )
    contact = fields.CharField(
        max_length=11, null=True, description="联系方式（手机号）"
    )
