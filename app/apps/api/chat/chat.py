...
from apps.utils.react_sse import SSE_HEADERS, iter_sse_from_agent_streaming, sse_data_line
...
@router.post("/ask/stream", summary="流式智能问答", description="XML ReAct + 数据库 schema/SQL（仅流式）", dependencies=[Depends(get_current_user)])
async def ask_question_stream(
    ...
    return StreamingResponse(generate_stream(), media_type="text/plain", headers=SSE_HEADERS)
