...
@router.get(
    "/health", summary="系统健康检查", description="检查系统各组件状态（无需登录）"
)
...
async def get_system_resources():
    ...
    try:
        ...
        system_data = {
            ...
            "memory": {"usage_percent": round(memory_percent, 1)},
            "disk": {"usage_percent": round(disk_percent, 1)},
        }
